	            ...
	            <div id="login_input">
	             ...
	             <div class="col-lg-12">
                    <div class="blog__details__hero__text">
                        <h2>쇼핑몰</h2> 
                        <figure>
				          <header class="heading" style="color:white"> <span style="color:yellow;font-weight:bold;"></span>부족한 재료를 간편하게 구매 해 보세요!</header>
				        </figure>
                    </div>
                </div>
	            </div>
                ...
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">             
                        <div class="sidebar__item">
                         <h4 style="margin-top: 4em;">장바구니 목록</h4>
                                        ...
                                        <c:forEach var="cvo" items="${printulist }" varStatus="c">       
                                       	<a href="../recipe/cart_delete.do?no=${cvo.no }&page=${curpage}" style="width: 260px;">
                                               ...
                                               <div class="card_title_title" id="card_title"style="height: 110px;width: 150px;float: left;">
                                                  ...
                                                  <h6 style="padding-top: 15px;" ><fmt:formatNumber value="${cvo.price }" pattern="0,000"/>원</h6>
                                               </div>
                                         	</div>
                                       	   </a>
                                  </c:forEach>
